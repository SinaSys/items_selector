...
class RadioSelectorItem extends RadioListTile {
  const RadioSelectorItem({
    ...
    super.radioBackgroundColor,
    super.radioInnerRadius,
    super.radioScaleFactor,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    ...
    if (contentPadding != null) {
      properties.add('contentPadding: $contentPadding');
    }
    if (controlAffinity != null) {
      properties.add('controlAffinity: $controlAffinity');
    }
    if (dense != null) properties.add('dense: $dense');
    if (enableFeedback != null) {
      properties.add('enableFeedback: $enableFeedback');
    }
    ...
    if (materialTapTargetSize != null) {
      properties.add('materialTapTargetSize: $materialTapTargetSize');
    }
    ...
    if (selectedTileColor != null) {
      properties.add('selectedTileColor: $selectedTileColor');
    }
    ...
    if (internalAddSemanticForOnTap == true) {
      properties
          .add('internalAddSemanticForOnTap: $internalAddSemanticForOnTap');
    }
