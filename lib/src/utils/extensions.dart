...
import 'package:items_selector/src/widget/single_list_item_selector.dart';
...
extension BaseSelectorExtension<T> on BaseSelectorState<T> {
  ...
  SingleListItemSelector get singleListItemSelectorWidget => widget as SingleListItemSelector<T>;
