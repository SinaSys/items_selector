...
class WrapSingleStringExample extends StatelessWidget {
  const WrapSingleStringExample({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Single wrap item (String)"),
      ),
      body: Column(
        children: [
          SingleWrapItemSelector<String>(
