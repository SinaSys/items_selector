...
class WrapSingleIntExample extends StatelessWidget {
  const WrapSingleIntExample({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Single wrap item (Int)"),
      ),
      body: SizedBox(
        height: 200,
        child: SingleWrapItemSelector<int>(
          items: integerItems,
