...
class WrapSingleObjectExample extends StatelessWidget {
  const WrapSingleObjectExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Single wrap item (Object)"),
      ),
      body: SingleWrapItemSelector<Person>(
