...
class WrapSingleEnumExample extends StatelessWidget {
  const WrapSingleEnumExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Single wrap item (Enum)"),
      ),
      body: Column(
        children: [
          SingleWrapItemSelector<Language>(
