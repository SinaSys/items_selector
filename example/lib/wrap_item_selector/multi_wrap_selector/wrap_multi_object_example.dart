...
class WrapMultiObjectExample extends StatelessWidget {
  const WrapMultiObjectExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Multi wrap item (Object)"),
      ),
      body: MultiWrapItemSelector<Person>(
