...
class WrapMultiIntExample extends StatelessWidget {
  const WrapMultiIntExample({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Multi wrap item (Int)"),
      ),
      body: SizedBox(
        height: 200,
        child: MultiWrapItemSelector<int>(
          items: integerItems,
